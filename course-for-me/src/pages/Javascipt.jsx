...
import JavaScriptVid from '../assets/JavaScript';

const Javascipt = (props) => {
  return (
    props.isAuth ? (
        <div>
          ...
          <Link to="/Payment"><div className='flex items-center w-[40px] h-[50px]'><IoMdArrowDropleft size={30}/><span className='text-black'>Back</span></div></Link>
            ...
            <br />
            <div className='w-full flex items-center justify-center'><video src={JavaScriptVid} controls className='h-[400px]'></video></div>
